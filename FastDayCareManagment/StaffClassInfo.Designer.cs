namespace FastDayCareManagment
{
    partial class StaffClassInfo
    {
        ...
        private void InitializeComponent()
        {
            ...
            // button9
            // 
            button9.BackColor = Color.FromArgb(255, 166, 43);
            ...
            // comboBox1
            // 
            comboBox1.AutoCompleteCustomSource.AddRange(new string[] { "Class A", "Class B", "Class C" });
            comboBox1.Font = new Font("Century Gothic", 11.25F, FontStyle.Regular, GraphicsUnit.Point, 0);
            comboBox1.FormattingEnabled = true;
            comboBox1.Items.AddRange(new object[] { "Classroom A", "Classroom B", "Classroom C" });
            comboBox1.Location = new Point(1106, 171);
