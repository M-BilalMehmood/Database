...
{
    public partial class AdminMailsSent : Form
    {
        public AdminMailsSent()
        {
            InitializeComponent();
            PopulateSentMailsGrid();
        }

        private void RecievedMails_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {

        }
        private void PopulateSentMailsGrid()
        {
            AdminController adminController = new AdminController();
            RecievedMails.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            RecievedMails.DataSource = adminController.GetSentMails();
        }
